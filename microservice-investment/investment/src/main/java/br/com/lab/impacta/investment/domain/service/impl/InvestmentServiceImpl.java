...
public class InvestmentServiceImpl implements InvestmentService {
    ...
    public Investment Invest(Long productId, Long accountId, Double valueInvestment) {
        ...
        if(product.isEmpty())
            throw new InvestmentProductNotFoundException(messageExceptionProductNotFound,
        ...
        if(!isDebited)
            throw new InvestmentAccountIsNotDebitedException(messageExceptionAccountIfNotDebited,
